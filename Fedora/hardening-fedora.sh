...
SERVICES_TO_REMOVE=("avahi-daemon" "cups" "fwupd-refresh.timer" "rpcbind"
                    "sysstat-summary.timer" "ipc_broker" "bluetooth"
                    "identity" "postgres" "rpc.idmapd" "rpc.statd"
...
firewall-cmd --zone=public --add-port=25/tcp --permanent    # SMTP inbound
...
firewall-cmd --permanent --direct --add-rule ipv4 filter OUTPUT 1 -p tcp --dport 25 -j ACCEPT
...
# ==============================================================================
# 8. Webmail Configuration Hardening
# ==============================================================================

log_info "--- Section 9: POP3/SMTP Hardening ---"
